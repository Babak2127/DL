...
|----------|-------|
| **File** | `150290b000a2` |
| **URL** | https://guardnet.ir/f/150290b000a2 |
| **Date** | 2026-05-13 13:38:49 UTC |
| **Status** | **FAILED** |
...
```
Download failed after 3 attempts. Last error: #=#=#                                                                          curl: (7) Failed to connect to guardnet.ir port 443 after 150 ms: Couldn't connect to server
```
